...
export const metadata: Metadata = {
  title: 'Sliding Windows | Premium uPVC Sliding Windows Chittoor',
  description: 'Premium uPVC sliding windows in Chittoor District. Space-saving, smooth operation, and energy-efficient sliding windows. Call +91 9949360406',
  keywords: [
    'sliding windows',
    'uPVC sliding windows',
    'sliding windows Chittoor',
    'space saving windows',
    'smooth sliding windows',
    'Chittoor District windows',
    'Andhra Pradesh sliding'
  ],
  openGraph: {
    title: 'Sliding Windows | Premium uPVC Sliding Windows Chittoor',
    description: 'Premium uPVC sliding windows in Chittoor District. Space-saving, smooth operation, and energy-efficient sliding windows.',
    type: 'website',
    locale: 'en_IN',
  },
}
      ...
      <section className="relative h-[50vh] flex items-center overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white pt-16 lg:pt-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block text-xs tracking-widest uppercase bg-white/10 px-3 py-1 rounded-full mb-4">Sliding Windows</span>
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
              Premium <span className="text-yellow-300">uPVC Sliding Windows</span>
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto mb-6">
              Space-saving, smooth operation, and energy-efficient windows crafted for modern homes in Chittoor District.
            </p>
              ...
              <div className="bg-teal-50 p-8 rounded-lg">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <div className="text-teal-500 text-xl mr-3">✓</div>
                    <span>Two sashes slide horizontally</span>
                  </li>
                  <li className="flex items-start">
                    <div className="text-teal-500 text-xl mr-3">✓</div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="text-gray-600">1.3 W/m²K</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
                  ...
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="text-gray-600">40 dB</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-teal-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-teal-600">Thermal Insulation</h4>
                    <p className="text-gray-600">Multi-chamber design provides excellent thermal performance</p>
                  </div>
                  
                  <div className="bg-teal-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-teal-600">Air Tightness</h4>
                    <p className="text-gray-600">Advanced sealing system prevents air leakage and drafts</p>
                  </div>
                  
                  <div className="bg-teal-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-teal-600">Condensation Control</h4>
                    <p className="text-gray-600">Reduces condensation and moisture problems</p>
                  </div>
                  
                  <div className="bg-teal-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-teal-600">UV Protection</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Get Your Sliding Windows Today
            </h2>
            <p className="text-xl mb-8">
              Premium quality sliding windows with 25+ years warranty. Free consultation and advice.
            </p>
